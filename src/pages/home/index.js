    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        ...
        <Card>
          ...
          <CardContent>
            <Typography sx={{ mb: 2 }}>
              <TextField id='outlined-multiline-flexible' label='Mã order' maxRows={8} inputRef={ref} />
              <br />
              <Button sx={{ mt: 3 }} variant='contained' onClick={handleSearchOrder}>
                Tra cứu
              </Button>
            </Typography>
            ...
            {isLoading === true ? (
              <Stack
                sx={{ mt: 5, display: 'flex', justifyContent: 'center', color: 'grey.500' }}
                spacing={2}
                direction='row'
              >
...
Home.getLayout = page => {
  return <CheckComponent>{page}</CheckComponent>
}
